...
public class LabyrinthAction implements ModAction
{
    ...
    public LabyrinthAction() {
        ...
        ModActions.registerAction(this.actionEntry = ActionEntry.createEntry(LabyrinthAction.actionId, "Labyrinth", "creating", new int[] { 23, 6 }));
    }
    ...
    public ActionPerformer getActionPerformer() {
        return new ActionPerformer() {
            ...
            public boolean action(final Action act, final Creature performer, final int tilex, final int tiley, final boolean onSurface, final int tile, final short action, final float counter) {
                ...
                if (!Mod.isTestEnv() && performer.getPower() < LabyrinthAction.requiredGMlevel && Cooldowns.isOnCooldown(playerEffect, LabyrinthAction.cooldown)) {
